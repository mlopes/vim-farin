let g:airline#themes#farin#palette = {}
...
let g:airline#themes#farin#palette.normal =
    \ airline#themes#generate_color_map(s:N1, s:N2, s:N3, s:N4, s:N5, s:N6)
let g:airline#themes#farin#palette.normal_modified = {
...
let g:airline#themes#farin#palette.insert =
    \ airline#themes#generate_color_map(s:I1, s:I2, s:I3, s:N4, s:N5, s:N6)
let g:airline#themes#farin#palette.insert_paste = {
...
let g:airline#themes#farin#palette.replace =
...
let g:airline#themes#farin#palette.visual =
...
let g:airline#themes#farin#palette.inactive =
  \ airline#themes#generate_color_map(s:IA1, s:IA2, s:IA3, s:IA3, s:IA3, s:IA3)

let g:airline#themes#farin#palette.accents = {
            \ 'red': [ '#BF472C', '', 130, '', 'bold' ]
            \ }

let g:airline#themes#farin#palette.tabline = {
...
let g:airline#themes#farin#palette.ctrlp =
